...
```
　strings では式中での以下の演算子や識別子をサポートします。リストは演算の優先順位で並んでいます。
...
### キーワード
　式中では値として定義されたキーワードを使えます。

#### nai
　JavaScript の null に対応します。
#### hu
　JavaScript の undefined に対応します。
#### shin
　JavaScript の true に対応します。
#### gi
　JavaScript の false に対応します。
